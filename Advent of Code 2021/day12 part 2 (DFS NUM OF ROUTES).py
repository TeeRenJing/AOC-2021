...
def findnumofroutes(inputdict,node,stack,backtopart1):
    ...
    if backtopart1:
        ...
        #     return 1
            ...
            for ele in inputdict[node]:
                if ele.islower() and ele in stack:
                    ...
                    count += findnumofroutes(inputdict,ele,stack+[ele],True)
        ...
        if node == 'end':
            ...
            for ele in inputdict[node]:
                if ele == 'start':
                    continue
                elif ele.islower() and ele in stack:
                    count += findnumofroutes(inputdict,ele,stack+[ele],True)
                else:
                    # print (f"gonna func {ele} next")
                    ...
                    count += findnumofroutes(inputdict,ele,stack+[ele],False)
                    # print(f'count is {count} for {node}')
            return count

    
print(findnumofroutes(inputdict,'start',stack,backtopart1))
