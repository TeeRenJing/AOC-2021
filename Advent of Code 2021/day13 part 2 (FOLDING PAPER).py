...
foldyaxis(inputdict,447)
foldxaxis(inputdict,327)
foldyaxis(inputdict,223)
foldxaxis(inputdict,163)
foldyaxis(inputdict,111)
foldxaxis(inputdict,81)
foldyaxis(inputdict,55)
foldxaxis(inputdict,40)
foldyaxis(inputdict,27)
foldyaxis(inputdict,13)
foldyaxis(inputdict,6)
